 # The program is used for performing social network analysis on Harry Potter Scripts. Used to understand speaker-listner relation in the HP movie.
# It creates a characater communication graph based on number of dialouges exchanged and   
...
l <- layout_with_fr(hpnet, niter = 50) #different layout

#code for node size to depict betweeness
